...
def exp_DRC(targname):
    ...
    outArr[:,7] = drc['x_i']
    outArr[:,8] = drc['y_i']
    outArr[:,9] = drc['magRaw_i']
    outArr[:,10] = np.arange(0,len(drc),1)

    header = 'RA_f606w DEC_f606w x_f606w y_f606w magr_f606w RA_f814w DEC_f814w x_f814w y_f814w magr_f814w id'
    form = "%1.7f %1.7f %1.5f %1.5f %1.5f %1.7f %1.7f %1.5f %1.5f %1.5f %d"
