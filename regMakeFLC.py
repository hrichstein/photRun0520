...
file = np.genfromtxt(workDir+'matched_w_MagsPos2705r2.dat')
...
# np.savetxt('flc50source.reg',file_50[:,[RA,DEC]],fmt='%1.7f')
...
np.savetxt(workDir+'flc100source.dat',file_100[:,[xt1,yt1,id]],fmt='%1.5f %1.5f %d')
