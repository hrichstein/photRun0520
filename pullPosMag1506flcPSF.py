...
def pullFunc(filter):
    if filter=='F606W':
        ...
        outname= 'matchedFLCpsf1506_606.dat'
        ...
        outname= 'matchedFLCpsf1506_814.dat'
    ...
    header= 'RA DEC flags c_star magZPT magZPTerr xPSF_trans yPSF_trans xPSF_mas yPSF_mas magPSF magErrPSF nstar id_cat'
