...
out = data[:,[RA, DEC, flags, c_star, mag1, mag2, mag3, mag4, xt1, yt1]]

data = np.hstack((out, newCol))

header = 'RA DEC flags c_star mag1 mag2 mag3 mag4 xt1 yt1 mean stdev cut_flag idx_cut num_abv_std'
