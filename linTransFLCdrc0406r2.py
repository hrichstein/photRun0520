...
cat = np.genfromtxt(dir+'matchedFLCdrc0406r3.dat')
...
all_cat = np.genfromtxt(dir+'flcDRCpos0406r3.dat')
...
def addTranscols(targname,filt,dir='catRawMags1305/catDir/'):
    ...
    transCat = np.genfromtxt(dir + 'flcDRCmatch0406r4.dat')
    ...
    np.savetxt(dir+'flcDRCpos0406r4.dat', cat, header=header)
